...
Generated: 2026-04-18T13:32:56.245Z
Harness: session-rail-truth-harness.mjs v1.0.0
Template pool: static_EXERCISE_TEMPLATES_fallback
...
- **secondary_type A/B:** Final classification from this run: **secondary_type metadata-only**
...
Static-neutral artifacts: `C:\projects\my-app\artifacts\session-rail\static-neutral`
- Per case: `*_freq*.json`
...
Artifacts: `C:\projects\my-app\artifacts\session-rail\adaptive-branch`

## 6. secondary_type A/B summary

Artifacts: `C:\projects\my-app\artifacts\session-rail\secondary-type-ab`
- `ab-summary.json` — per-session classification + aggregate.

## 7. Final classification (secondary_type)

**secondary_type metadata-only**

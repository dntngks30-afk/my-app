...
const FIXTURES = [
  ...
  { id: 'boost-4-axes',   label: 'D=4,B=4,C=4,F=4, G=3, A=1 → DECOND 기대', answers: { ...all(1), v2_D1:4,v2_D2:4,v2_D3:4, v2_B1:4,v2_B2:4,v2_B3:4, v2_C1:4,v2_C2:4,v2_C3:4, v2_F1:4,v2_F2:4,v2_F3:4, v2_G1:3,v2_G2:3,v2_G3:3 } },
];
...
console.log('\n═══════════════════════════════════════════════════════════════════════');
console.log('  PR-FREE-SURVEY-MULTI-AXIS-DEEP-MAPPING-01 — 회귀 비교');

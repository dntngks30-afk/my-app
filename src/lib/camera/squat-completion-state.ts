...
function applyCompletionOwnerShallowAdmissibilityReopen(
  ...
  return {
    ...
    canonicalShallowContractClosureSource: 'owner_shallow_reopen_align',
    ultraLowPolicyScope:
      ownerReason === 'ultra_low_rom_complete_rule'
        ? true
        : state.ultraLowPolicyScope,
    ultraLowPolicyDecisionReady:
      ownerReason === 'ultra_low_rom_complete_rule'
        ? true
        : state.ultraLowPolicyDecisionReady,
    ultraLowPolicyBlocked:
      ownerReason === 'ultra_low_rom_complete_rule'
        ? false
        : state.ultraLowPolicyBlocked,
  };
}
